...
var myDataRef = new Firebase('https://rockps.firebaseio.com/');
var chatData = new Firebase('https://rockps.firebaseio.com/chat');
var playersRef = new Firebase('https://rockps.firebaseio.com/players');
var currentTurnRef = new Firebase('https://rockps.firebaseio.com/turn');
...
function getInGame() {
  ...
  var chatDataDisc = new Firebase('https://rockps.firebaseio.com/chat/' + Date.now());
  ...
  if (currentPlayers < 2) {
    ...
    playerRef = new Firebase('https://rockps.firebaseio.com/players/' + playerNum);
